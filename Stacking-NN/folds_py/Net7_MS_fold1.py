...
def main():
    ...
    MODEL_NAME = 'multiscale_se_resnext'
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        COMMON_MODEL_PATH = op.join(MODEL_DIR,'SGD_MS_fold1_{}.pth'.format(epoch+1))
        BEST_MODEL_PATH   = op.join(BEST_DIR,'{}_SGD_MS_fold1_{}.pth'.format(MODEL_NAME,epoch+1))
